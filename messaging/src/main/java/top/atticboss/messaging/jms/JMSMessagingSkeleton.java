...
import top.atticboss.messaging.Topic;
import top.atticboss.messaging.WithCloseables;
...
public abstract class JMSMessagingSkeleton extends WithCloseables implements Messaging {
    ...
    private final static Logger log = AtticBoss.logger("top.atticboss.messaging.jms");
