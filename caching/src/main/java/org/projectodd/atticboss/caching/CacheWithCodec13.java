...
public class CacheWithCodec13 extends CacheWithCodec {

    public CacheWithCodec13(Cache cache, Codec codec) {
        super(cache, codec);
    }
    ...
    class EncodedCache extends AbstractCollection implements CacheSet {
        ...
        @Override
        public int size() {
            return CacheWithCodec13.this.size();
        }

        @Override
        public CacheStream stream() {
            return new LocalCacheStream(new EntryStreamSupplier(cache,
                    getSegmentMapper(cache),
       ...
       private ConsistentHash getConsistentHash(Cache cache) {
           ...
           return (dm != null) ? dm.getCacheTopology().getReadConsistentHash() : null;
       }
        ...
        private Cache cache = CacheWithCodec13.this;
    }
}
