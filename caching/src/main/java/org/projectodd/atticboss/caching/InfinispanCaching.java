...
public class InfinispanCaching implements Caching {
    ...
    public boolean stop(String name) {
        ...
        mgr.administration().removeCache(name);
    ...
    public synchronized EmbeddedCacheManager manager() {
        if (this.manager == null) {
            GlobalConfigurationBuilder gBuilder = new GlobalConfigurationBuilder();
                gBuilder
                  ...
                  .allowList().addRegexp(".*").create();
                this.manager = new DefaultCacheManager(gBuilder.build(),
